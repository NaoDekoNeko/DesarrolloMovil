...
public class MyAdaptadorWeb extends BaseAdapter {
    Context context;
    MyAdaptadorWeb(Context c){context = c;}
    @Override
    public int getCount(){return MainActivity.miscontactosweb.size();}
    @Override
    public Object getItem(int position){
        return MainActivity.miscontactosweb.get(position);
    }
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        String nombre = MainActivity.miscontactosweb.get(position).getNombre();
        String alias = MainActivity.miscontactosweb.get(position).getAlias();
        int tipo = MainActivity.miscontactosweb.get(position).getTipo();
